...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div id="foot" class="svelte-wd7jzg"><div class="foot-left svelte-wd7jzg">8mu Editor v${escape(buildVersion)} <br>Having trouble? Please try <a href="https://tomwhitwell.github.io/test-host/">v1.0.1</a> and <a href="https://github.com/TomWhitwell/8mu_Public/issues">let me know</a>.
    </div></div>
</main>`;
});
export {
